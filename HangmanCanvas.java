...
//		case 8: addFootR();
	...
	private void addArmL() {
		GLine shoulderL = new GLine(50 + BEAM_LENGTH, ARM_OFFSET_FROM_HEAD + 50 + ROPE_LENGTH + 2 * HEAD_RADIUS, 50 + BEAM_LENGTH - UPPER_ARM_LENGTH, 100 + ROPE_LENGTH + 2 * HEAD_RADIUS);
		GLine armL = new GLine(50 + BEAM_LENGTH - ARM_OFFSET_FROM_HEAD, 100 + ROPE_LENGTH + 2 * HEAD_RADIUS, 50 + BEAM_LENGTH - ARM_OFFSET_FROM_HEAD, 100 + ROPE_LENGTH + 2 * HEAD_RADIUS + LOWER_ARM_LENGTH)
	}
